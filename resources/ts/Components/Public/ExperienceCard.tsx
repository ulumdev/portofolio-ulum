...
//             style={{ animationDelay: `${index * 0.1}s` }}
//         >
//             <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
//                 {/* Header - Compact */}
//                 <div className="flex items-start gap-4 mb-4">
//                     {/* Company Logo */}
//                     <div className="flex-shrink-0">
...
//                                                 <span
//                                                     key={idx}
//                                                     className="px-2.5 py-1 bg-gradient-to-r from-primary-50 to-purple-50 dark:from-primary-900/20 dark:to-purple-900/20 text-primary-700 dark:text-primary-300 rounded-lg text-xs font-medium border border-primary-200 dark:border-primary-800"
//                                                 >
//                                                     {tech}
//                                                 </span>
//                                             )
...
//                                                 >
//                                                     <span className="w-1.5 h-1.5 bg-primary-500 dark:bg-primary-400 rounded-full mr-2.5 mt-1.5 flex-shrink-0"></span>
