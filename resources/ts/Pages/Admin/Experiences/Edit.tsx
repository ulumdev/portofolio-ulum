...
export default function EditExperience({ experience }: EditExperienceProps) {
  ...
  const [previewLogo, setPreviewLogo] = useState<string | null>(
    experience.company_logo ?  `/storage/${experience.company_logo}` : null
  );
  ...
  const submit: FormEventHandler = (e) => {
    ...
    setData('responsibilities', data.responsibilities.filter(r => r.trim() !== ''));
    setData('technologies', data.technologies.filter(t => t.trim() !== ''));
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-6 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">Update work experience details</p>
          </div>
