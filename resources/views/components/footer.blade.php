...
<footer class="bg-gray-800 text-white mt-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- About Section -->
            <div>
                <h3 class="text-xl font-bold mb-4">{{ config('app.name', 'Portfolio') }}</h3>
                <p class="text-gray-400">
                    Showcasing my work and sharing knowledge through blog posts.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('portofolio.index') }}" class="text-gray-400 hover:text-white">Portfolio</a></li>
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    @if($githubUrl && $githubUrl != '#')
                        <a href="{{ $githubUrl }}" target="_blank" class="text-gray-400 hover:text-white">
                    ...
                    @if($linkedinUrl && $linkedinUrl != '#')
                        <a href="{{ $linkedinUrl }}" target="_blank" class="text-gray-400 hover:text-white">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    @if($twitterUrl && $twitterUrl != '#')
                        <a href="{{ $twitterUrl }}" target="_blank" class="text-gray-400 hover:text-white">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
